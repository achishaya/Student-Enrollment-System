...
public class PostgraduateStudentDetails extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Postgraduate Student details");
        setBackground(new java.awt.Color(255, 255, 255));
        setPreferredSize(new java.awt.Dimension(1593, 830));

        jPanel1.setBackground(new java.awt.Color(255, 255, 255));
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Postgraduate Student Details", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Calibri", 3, 24), new java.awt.Color(0, 102, 255))); // NOI18N

        jLabel1.setFont(new java.awt.Font("Calibri", 3, 18)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(51, 102, 255));
        jLabel1.setText("Registration Number :");

        code.setFont(new java.awt.Font("Calibri", 3, 18)); // NOI18N
        ...
        name.setFont(new java.awt.Font("Calibri", 3, 18)); // NOI18N
        name.setForeground(new java.awt.Color(102, 102, 102));

        address.setFont(new java.awt.Font("Calibri", 3, 18)); // NOI18N
        address.setForeground(new java.awt.Color(102, 102, 102));

        gender.setFont(new java.awt.Font("Calibri", 3, 18)); // NOI18N
        gender.setForeground(new java.awt.Color(102, 102, 102));

        mobile.setFont(new java.awt.Font("Calibri", 3, 18)); // NOI18N
        mobile.setForeground(new java.awt.Color(102, 102, 102));

        email.setFont(new java.awt.Font("Calibri", 3, 18)); // NOI18N
        email.setForeground(new java.awt.Color(102, 102, 102));

        degree.setFont(new java.awt.Font("Calibri", 3, 18)); // NOI18N
        degree.setForeground(new java.awt.Color(102, 102, 102));

        institute.setFont(new java.awt.Font("Calibri", 3, 18)); // NOI18N
        institute.setForeground(new java.awt.Color(102, 102, 102));

        year.setFont(new java.awt.Font("Calibri", 3, 18)); // NOI18N
        year.setForeground(new java.awt.Color(102, 102, 102));

        faculty.setFont(new java.awt.Font("Calibri", 3, 18)); // NOI18N
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(address, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(degree, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel8, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(institute, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(faculty, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String add = "address";
        String gen = "gender";
        String deg = "qualification_type";
        String ins = "institute";
        String yea = "year";
        String mob = "mobile";
        String ema = "email";
        String fac = "faculty";
        ...
        rs = dbops.findPStudent(code.getText());
        ...
        try{
            if(rs.next()){
                ...
                degree.setText(rs.getString(deg));
                institute.setText(rs.getString(ins));
                year.setText(rs.getString(yea));
